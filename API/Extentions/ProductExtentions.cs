...
namespace API.Extentions
{
    public static class ProductExtentions
    {
        ...
        public static IQueryable<Product> Search(this IQueryable<Product> query, string searchTerm)
        {
            ...
            var lowerCaseSearchTerm = searchTerm.Trim().ToLower(); //Trim() removes additional white space
        ...
        public static IQueryable<Product> Filter(this IQueryable<Product> query , string brand, string type)
        {
            ...
            query = query.Where(p => typeList.Count == 0 || typeList.Contains(p.TypeofProduct.ToLower()));
            return query;
        }
    }
}